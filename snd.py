...
seq_t = rffi.COpaque("snd_seq_t")
seq_tp = lltype.Ptr(seq_t)
# seq_tpp = lltype.FixedSizeArray(seq_tp, 1)
...
seq_open = ext("seq_open", [rffi.VOIDP, rffi.CCHARP, rffi.INT, rffi.INT],
               rffi.INT)
seq_close = ext("seq_close", [seq_tp], lltype.Void)
seq_set_client_name = ext("seq_set_client_name", [seq_tp, rffi.CCHARP],
                          rffi.INT)
seq_create_simple_port = ext("seq_create_simple_port",
                             [seq_tp, rffi.CCHARP, rffi.UINT, rffi.UINT],
                             rffi.INT)
